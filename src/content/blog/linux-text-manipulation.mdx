...
Today, I wanted to make a module for my AwesomeWM status bar that shows the currently playing Spotify song, it'd be nice if it could show something human-readable like this: _Wild World by Yusuf/Cat Stevens_.
