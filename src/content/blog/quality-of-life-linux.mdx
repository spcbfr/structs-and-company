...
This is a collection of my preferred small improvements to make using Linux more comfortable, I always procrastinate setting these up on a new system but when I eventually do it feels like a major upgrade.
