...
The team has made packages to control the fans and drivers and more, these are pre-installed in Pop Os (run `apt search system-*{:bash}`) which was nice to see
