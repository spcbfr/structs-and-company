...
<span class="leadin">Throughout the years</span>, The relationship between the blogger and the reader has always been mostly one-sided: the author publishes a new post and it gets consumed by the readers, but it's very hard for a discussion around the post to arise, some people have a comment section, but I've always found that solution to be very _flaky_, to say the least:
...
- <del class="line-through text-stone-700">Make a tweet that includes the URL of this post</del> Update: this no longer
  works since Twitter's API changes
- Reply to [this mastodon post](https://fosstodon.org/@spacebuffer/109564738532624537)
- <del class="line-through text-stone-700">Reply to this tweet</del> I've stopped using twitter long ago
