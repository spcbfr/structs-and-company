...
<div class="grid place-content-center place-items-center">
  <Img src="/og-image.png"  alt=""  class="sm:w-[36rem] w-[30rem] -rotate-12 [grid-row:1] [grid-column:1]"  />
  <Img src={homepage} alt="" class="sm:w-[30rem] w-[24rem] -rotate-6 [grid-row:1] [grid-column:1] delay-[1s]"/>
  <Img src={about} alt="Screenshot of about page" class="sm:w-[30rem] w-[24rem] rotate-12 [grid-row:1] [grid-column:1]  "  />
</div>
...
I was very tempted to switch to [`11`ty](11ty.dev) instead but a fully static site can't handle the experiments I run every now and then. 11ty remains a very good choice for most people, check it out if you haven't already.

One more thing: I am dropping the webmentions support and spotify widget for the time being, I can't delay this overhaul any further. They'll back soon though.
...
- my [RSS feed](/rss) is now styled when opened in a browser. Yes, you can style an RSS feed, and it's cool as heck. Oh and don't worry, the feed is still parse-able by your reader
